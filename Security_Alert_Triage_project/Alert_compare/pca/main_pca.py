...
@ describe: pagerank active learning test
@ tools: pycharm
"""
...
def pca_rank(data_week_data, iteration_name, dim_data):
    ...
    # data_rank.to_excel('./results_usp/ranking_results/' + iteration_name + '_pca_ranking_res.xlsx', index=False)
...
def main_pca(data_all_label, dimension_data, iteration_list, sample_k_list):
    ...
    print('edge: running pca algorithm...')
    for iteration_name in iteration_list:
        ...
        usp_ranking_fpr_fnr_result.to_excel(
            save_path + 'pca/results_usp/fpr_fnr_results/Iteration' + iteration_name[4] + '_ranking_fpr_and_fnr.xlsx',
            index=False)
        ...
        for k in sample_k_list:
            ...
            if last_iteration_name != 'Week0':
                ...
                rer_mer_res.to_excel(save_path + 'pca/results_sp/rank/rer_mer_results/Iteration' + iteration_name[4] + '_' +
                ...
                sp_class_fpr_fnr_res.to_excel(save_path + 'pca/results_sp/class/fpr_fnr_results/Iteration' + iteration_name[4] +
                                              '_' + str(k) + '_sp_ranking_fpr_and_fnr.xlsx', index=False)
                ...
                train_data_before = pd.read_excel(save_path + 'pca/train_data/Iteration' + last_iteration_name[4] + '_' + str(k)
                                                  + '_sample_data.xlsx')
                ...
                if not os.path.exists(save_path + 'pca/train_data/'):
                    os.makedirs(save_path + 'pca/train_data/')
                select_data.to_excel(save_path + 'pca/train_data/Iteration' + iteration_name[4] + '_' + str(k) + '_sample_data'
                                     + '.xlsx', index=False)
