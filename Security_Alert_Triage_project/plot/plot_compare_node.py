...
def plot_6_usp_bar_rer_mer_node():
    """ %node ranking: edgerank, isolation forest, auto-encoder, PCA, KDE, PageRank
    rer and mer plot
    """
    # config
    plt.rcParams['font.family'] = ['SimHei']
    ...
    for i in index_list:
        ...
        for iteration in iteration_list:
            file_path1 = './Node_compare/edgeRank/results_usp/host/rer_mer_results/' + iteration + '_rer_mer.xlsx'
            file_path2 = './Node_compare/pagerank/results_usp/host/rer_mer_results/' + iteration + '_rer_mer.xlsx'
            file_path3 = './Node_compare/ae/results_usp/rer_mer_results/' + iteration + '_rer_mer.xlsx'
            file_path4 = './Node_compare/kde/results_usp/rer_mer_results/' + iteration + '_rer_mer.xlsx'
            file_path5 = './Node_compare/pca/results_usp/rer_mer_results/' + iteration + '_rer_mer.xlsx'
            file_path6 = './Node_compare/iforest/results_usp/rer_mer_results/' + iteration + '_rer_mer.xlsx'
        ...
        # save
        if not os.path.exists(save_path + 'results/node_compare_results/mer_eer_rer/'):
            os.makedirs(save_path + 'results/node_compare_results/mer_eer_rer/')
        plt.savefig(save_path + 'results/node_compare_results/mer_eer_rer/' + 'usp_node_ranking_' + index + '.pdf',
                    bbox_inches='tight', dpi=500, format="pdf")
        # plt.show()
        plt.clf()


def plot_6_usp_bar_eer_node():
    """ %node ranking: edgerank, isolation forest, auto-encoder, PCA, KDE, PageRank
        eer
    """
    # config
    ...
    AE_list, kde_list, pca_list, iforest_list = [], [], [], [], [], [], [], [], []
    for iteration in iteration_list:
        file_path1 = './Node_compare/edgeRank/results_usp/host/fpr_fnr_results/' + iteration + '_ranking_fpr_and_fnr.xlsx'
        file_path2 = './Node_compare/pagerank/results_usp/host/fpr_fnr_results/' + iteration + '_ranking_fpr_and_fnr.xlsx'
        file_path3 = './Node_compare/ae/results_usp/fpr_fnr_results/' + iteration + '_ranking_fpr_and_fnr.xlsx'
        file_path4 = './Node_compare/kde/results_usp/fpr_fnr_results/' + iteration + '_ranking_fpr_and_fnr.xlsx'
        file_path5 = './Node_compare/pca/results_usp/fpr_fnr_results/' + iteration + '_ranking_fpr_and_fnr.xlsx'
        file_path6 = './Node_compare/iforest/results_usp/fpr_fnr_results/' + iteration + '_ranking_fpr_and_fnr.xlsx'
...
def plot_roc_node():
    ...
    for iteration in iteration_list:
        ...
        def export_legenf(legend):
            ...
            if not os.path.exists(save_path + 'results/node_compare_results/roc_node/'):
                os.makedirs(save_path + 'results/node_compare_results/roc_node/')
            fig.savefig(save_path + 'results/node_compare_results/roc_node/' + 'roc_node_ranking_legend.pdf', dpi=500, bbox_inches=bbox)
            # fig.show()
        ...
        if not os.path.exists(save_path + 'results/node_compare_results/roc_node/'):
            os.makedirs(save_path + 'results/node_compare_results/roc_node/')
        plt.savefig(save_path + '/results/node_compare_results/roc_node/' + 'usp_node_ranking_roc_' + str(iteration) + '.pdf',
                    bbox_inches='tight', dpi=500, format="pdf")
...
if __name__ == "__main__":
    ...
    plot_6_usp_bar_eer_node()
    plot_6_usp_bar_rer_mer_node()
    plot_roc_node()
