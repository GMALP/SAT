...
def edge_rank(data_week, iteration_name, fall_acc, high_acc, low_acc):
    ...
    '''
    if not os.path.exists(node_save_path + 'edgeRank/results_usp/host/ranking_results/'):
        os.makedirs(node_save_path + 'edgeRank/results_usp/host/ranking_results/')
    ranking_result_all.to_excel(node_save_path + 'edgeRank/results_usp/host/ranking_results/Iteration' +
     iteration_name[4] + '_ranking_results.xlsx', index=False)
    '''
    # Aggregate source IP processing...
    aggregate_result = process.result_aggregation(ranking_result)
    '''
    if not os.path.exists(node_save_path + 'edgeRank/results_usp/host/aggregate_results/'):
        os.makedirs(node_save_path + 'edgeRank/results_usp/host/aggregate_results/')
    aggregate_result.to_excel(node_save_path + 'edgeRank/results_usp/host/aggregate_results/Iteration' + 
    ...
    if not os.path.exists(node_save_path + 'edgeRank/results_usp/host/fpr_fnr_results/'):
        os.makedirs(node_save_path + 'edgeRank/results_usp/host/fpr_fnr_results/')
    ranking_fpr_fnr_result.to_excel(node_save_path + 'edgeRank/results_usp/host/fpr_fnr_results/Iteration' +
    ...
    if not os.path.exists(node_save_path + 'edgeRank/results_usp/host/rer_mer_results/'):
        os.makedirs(node_save_path + 'edgeRank/results_usp/host/rer_mer_results/')
    rer_mer_res.to_excel(node_save_path + 'edgeRank/results_usp/host/rer_mer_results/Iteration' + iteration_name[4] +
    ...
    edge_ranking_result = edge_confidence_compute.ga_edge_confidence_compute(ranking_result_all, fall_acc,
                                                                             high_acc, low_acc)
    '''
    if not os.path.exists(alert_save_path + 'edgeRank/results_usp/alert/ranking_results/'):
        os.makedirs(alert_save_path + 'edgeRank/results_usp/alert/ranking_results/')
    edge_ranking_result.to_excel(alert_save_path + 'edgeRank/results_usp/alert/ranking_results/Iteration' + 
    iteration_name[4] + '_ranking_results.xlsx', index=False)
    '''
    # Alert Ranking results evaluate...
    # Ranking FPR and FNR evaluate
    alert_ranking_fpr_fnr_result = ranking_fpr_fnr_compute.ranking_fpr_fnr_compute(edge_ranking_result, 'alert')
    # compute optimize fpr and fnr
    ...
    if not os.path.exists(alert_save_path + 'edgeRank/results_usp/alert/fpr_fnr_results/'):
        os.makedirs(alert_save_path + 'edgeRank/results_usp/alert/fpr_fnr_results/')
    alert_ranking_fpr_fnr_result.to_excel(alert_save_path + 'edgeRank/results_usp/alert/fpr_fnr_results/Iteration'
                                          + iteration_name[4] + '_ranking_fpr_and_fnr.xlsx', index=False)

    # Alert RE and MER evaluate
    rer_mer_res = ranking_rer_mer_compute.rer_mer_compute(edge_ranking_result)
    if not os.path.exists(alert_save_path + 'edgeRank/results_usp/alert/rer_mer_results/'):
        os.makedirs(alert_save_path + 'edgeRank/results_usp/alert/rer_mer_results/')
    rer_mer_res.to_excel(alert_save_path + 'edgeRank/results_usp/alert/rer_mer_results/Iteration' + iteration_name[4]
                        + '_rer_mer.xlsx', index=False)
