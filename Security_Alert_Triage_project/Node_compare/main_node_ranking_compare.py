...
def task1():  #
   ...
   #  data_all = pd.read_excel('./alert_data/alert_data.xlsx')
    ...
    main_ae.main_ae(data_all_label, dimension_data, iteration_list, Sample_K_list)
    gc.collect()
...
def node_compare(data_all):
    ...
    Sample_K_list = [100]
    iteration_list = ['Week1', 'Week2', 'Week3', 'Week4', 'Week5', 'Week6', 'Week7', 'Week8']  # 8 iterations
    # main_edgerank_node.main_er(data_all, data_all_label, dimension_data, iteration_list, Sample_K_list, fall_acc, high_acc, low_acc)
    main_ae_node.main_ae(data_all_label, dimension_data, iteration_list, Sample_K_list)
    main_if_node.main_if(data_all_label, dimension_data, iteration_list, Sample_K_list)
    main_kde_node.main_kde(data_all_label, dimension_data, iteration_list, Sample_K_list)
    # main_pr_node.main_pr(data_all, data_all_label, dimension_data, iteration_list, Sample_K_list, fall_acc, high_acc, low_acc)
    main_pca_node.main_pca(data_all_label, dimension_data, iteration_list, Sample_K_list)
